      ...
      <div id="chatBox" class="chatBox">
        <div class="card">
          <header class="card-header header-title" @click="toggleChat()">
            <p class="card-header-title">
              <i class="fa fa-circle is-online" /><img src="https://k0.okccdn.com/php/load_okc_image.php/images/32x0/971x939/0/10846088441021659030.webp?v=2" style="width: 30px;">&nbsp;{{ headUser }}
            </p>
          ...
          <div id="chatbox-area">
            ...
            <footer id="chatBox-textbox" class="card-footer">
              <div style="width: 63%;">
                <textarea id="chatTextarea" class="chat-textarea" placeholder="Digite aqui" @focus="expandTextArea()" @blur="dexpandTetArea()" />
              </div>
